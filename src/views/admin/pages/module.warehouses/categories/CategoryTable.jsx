...
export const CategoryTable = React.memo((props) => {
    const {
        stateSelect = false,
        stateMultiple = true,
        allItems = [],
                            ...
                            {items.map((category) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell>
                                            <SeverityPill color={category.state ? 'success' : 'error'}>
                                        ...
                                        <TableCell>
                                            ...
                                            >
                                                ...
                                                <Switch
                                                    ...
                                                    onChange={(event) => onEdit({ ...category, state: event.target.checked, userId: category.userId.id })}
                                                    color="success"
                                                    size="small"
